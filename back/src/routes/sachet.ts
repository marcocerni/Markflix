...
router.get('/domain', [checkJwt, checkRole(['ADMIN'])], SachetController.getUnsubscribedDomains)
router.post('/domain', [checkJwt, checkRole(['ADMIN'])], SachetController.unsubscribeDomains)
